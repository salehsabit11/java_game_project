...
public class GamePanel extends JPanel
    ...
    public GamePanel(int boardWidth, int boardHeight) {
        ...
        Image topPipeImage =
                loadImage("/asset/toppipe.png");

        Image bottomPipeImage =
                loadImage("/asset/bottompipe.png");

        Image birdImage =
                loadImage("/asset/bird.png");

        gameOverImg =
                loadImage("/asset/gameover.png");

        for (int i = 0; i < 10; i++) {

            digits[i] =
                    loadImage("/asset/" + i + ".png");
        }
